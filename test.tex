...
\def\tedtest{\emph{(Sourit, hoche la tête ; attitude
  bienveillante)} \underline{mais si} mais si \underline{ça nous
  intéresse} cette histoire de carabine \tabularnewline}%
\edef\tedtsp{\space\space}%
a\Substitute*[\def\tedtest]{\tedtest}{ ;}{}b\par
a\Substitute*[\def\tedtest]{\tedtest}{ :}{}b\par
a\Substitute*[\def\tedtest]{\tedtest}{ ?}{}b\par
a\Substitute*[\def\tedtest]{\tedtest}{ !}{}b\par
a\Substitute**[\def\tedtest]{\tedtest}{\tedtsp}{\empty}b\par
a\Substitute*{\tedtest}{ }{}b\par
